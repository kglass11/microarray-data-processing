...
ggplot(AHHHH.df, aes(x=slide_type, y=X31_1.GEXP18.100ug.ml_1, color = sample, shape = blocking_buffer)) +
   geom_point(size = 1)  +
   theme_bw() +
...
ggplot(AHHHH.df, aes(x=slide_type, y=X31_1.GEXP18.100ug.ml_1, color = print_buffer, fill = print_buffer)) +
