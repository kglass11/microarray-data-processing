...
setwd("C:/Users/iimmwsto/Google Drive/Backup/2017 Microarray/Tetteh 2017/CHMI Jenner")
path=("C:/Users/iimmwsto/Google Drive/Backup/2017 Microarray/Tetteh 2017/CHMI Jenner")
...
samples.df <- read.csv("sample list.csv", header=T, na.strings = " ", check.names = FALSE, stringsAsFactors = FALSE)
...
samples.df[,11] <- samples_unique
colnames(samples.df)[11] <- "sample_id_unique"
